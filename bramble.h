...
const uint longintronanchor = 25;
...
struct ReadInfo {
	...
	ReadInfo() : matches(), brec(nullptr), valid_read(false), read_index(0), read_size(0),
	             mate_name(), is_paired(false), is_first_mate(false), is_reverse(false),
				 mate_is_reverse(false), mate_info() {}
