...
-D_LARGEFILE_SOURCE -std=c++17 -fno-strict-aliasing -fno-exceptions -fno-rtti
...
ifdef DEBUG_BUILD
  #$(warning Building DEBUG version of bramble.. )
  DBG_WARN=@echo
...
OBJS += bramble.o bam.o reads.o tree.o

all release static static-cpp debug: bramble${EXE}
memcheck memdebug tsan tcheck thrcheck: bramble${EXE}
memuse memusage memtrace: bramble${EXE}
prof profile: bramble${EXE}
nothreads: bramble${EXE}

bramble.o : $(GDIR)/GBitVec.h $(GDIR)/GHashMap.hh $(GDIR)/GSam.h $(GDIR)/GStr.h
bam.o : bramble.h bam.h
tree.o : bramble.h tree.h bam.h
...
bramble${EXE}: ${HTSLIB}/libhts.a $(OBJS) bramble.o
	${LINKER} ${LDFLAGS} -o $@ ${filter-out %.a %.so, $^} ${LIBS}
	@echo
	${DBG_WARN}
test demo tests: bramble${EXE}
	@./run_tests.sh
